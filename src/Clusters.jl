...
Particle cluster consisting of 2 identical particles separated along x
- a,b,c: semi-axes along x,y,z
- dihedral: angle between both particles seen along the x-axis
...
function cluster_dimer(d, a, b, c, dihedral = 0.0, material = "Au", type="particle")
    ...
    positions = [SVector{3}(x, 0.0, 0.0) for x in (d/2, -d/2)]
